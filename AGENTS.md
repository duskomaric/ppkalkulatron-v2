...
For native build and run commands, use the platform the user specifies. If none is specified, ask whether the
target is iOS or Android.

=== nativephp/mobile-share rules ===
