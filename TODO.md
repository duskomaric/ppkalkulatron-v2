- [x] neke rute potrebno prevesti na srpski - tipa unlock i sl
      ...
      `/podesavanja/mail` i `/podesavanja/backup` su ostavljeni dok se labele u meniju ne prevedu.
...
- [ ] provjeriti imaju li statusi smisla nakon sto se stornira i fiskalizuje storno - predlozi izmjene - nema starih podataka - radimo migrate:fresh
