    ...
    <form method="POST" action="{{ route('settings.general.update') }}" class="space-y-8 animate-fade-in">
        ...
        <x-section-block variant="card">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <x-form-input label="Početni broj računa" name="invoice_starting_number" type="number" inputmode="numeric" :value="$numbering->invoice_starting_number" required />
                <x-form-input label="Broj nula (padding)" name="pad_zeros" type="number" inputmode="numeric" :value="$numbering->pad_zeros" required />
            </div>
        ...
        <x-section-block variant="card">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <x-form-input label="Rok plaćanja (dana)" name="invoice_due_days" type="number" inputmode="numeric" :value="$document->invoice_due_days" required />
            </div>
